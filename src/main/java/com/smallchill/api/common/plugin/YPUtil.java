...
public class YPUtil {
    ...
    // API KEY
    public static String apikey = "2e2a920d9ae62516a2542dd5aacc9867";

    // text modal
    public static String text_modal = "【首页】您的验证码是s";

    public static void main(String[] args) throws IOException, URISyntaxException {

        //修改为您的apikey.apikey可在官网（http://www.yunpian.com)登录后获取
        String apikey = "2e2a920d9ae62516a2542dd5aacc9867";

        //修改为您要发送的手机号
        String mobile = "13476107753";

        /**************** 查账户信息调用示例 *****************/
        // System.out.println(YPUtil.getUserInfo(apikey));

        /**************** 使用智能匹配模板接口发短信(推荐) *****************/
        //设置您要发送的内容(内容必须和某个模板匹配。以下例子匹配的是系统提供的1号模板）
        String text = "【首页】您的验证码是s";
        //发短信调用示例
//        System.out.println(YPUtil.sendSms(apikey, text, mobile));
    ...
    public static String sendSms(String apikey, String text, String mobile) throws IOException {
        Map<String, String> params = new HashMap<String, String>();
        params.put("apikey", apikey);
        text = text_modal.replace("s", text);
